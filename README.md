...
> **Linux:** paridade com o Windows pelos caminhos nativos do sistema — a
> conexão com o fone fala RFCOMM via BlueZ, e a correção de audição vira um
> sink virtual do PipeWire (`module-filter-chain`, os mesmos biquads RBJ),
> sem privilégio de administrador. Requisitos: BlueZ e PipeWire rodando, e
> `pactl` disponível — o padrão nas distribuições atuais. Quem preferir
> aplicar por conta própria (EasyEffects etc.) ainda pode baixar o perfil em
> formato Equalizer APO ou CSV na área avançada.
>
> **macOS:** o dmg traz o teste de audição, o perfil por ouvido e os
> downloads — a conexão com o fone e a correção de sistema ainda não.
