...
const DICIONARIOS = {
  "pt-BR": {
    ...
    "sis.apoAusente": "Equalizer APO não encontrado. Instale-o (gratuito, equalizerapo.com), marque o dispositivo do seu fone durante a instalação, reinicie o PC e volte aqui.",
    ...
    "audio.intro": "Vamos tocar grupos de 3 bipes, um ouvido de cada vez, sempre no mesmo volume — e você responde: «Ouvi» ou «Não ouvi». O volume do bipe seguinte se ajusta pela sua resposta, como num exame de audiometria. São 12 frequências, uns 3 minutos.",
  ...
  "en": {
    ...
    "sis.apoAusente": "Equalizer APO not found. Install it (free, equalizerapo.com), tick your earbud device during setup, reboot and come back.",
    ...
    "audio.intro": "We play groups of 3 beeps, one ear at a time, always at a fixed volume — and you answer: «I heard it» or «I did not». The next beep's level adjusts to your answer, like a real audiometry exam. 12 frequencies, about 3 minutes.",
  ...
  "es": {
    ...
    "sis.apoAusente": "Equalizer APO no encontrado. Instálalo (gratuito, equalizerapo.com), marca tu auricular durante la instalación, reinicia y vuelve.",
    ...
    "audio.intro": "Reproducimos grupos de 3 pitidos, un oído a la vez, siempre al mismo volumen — y tú respondes: «Lo oí» o «No lo oí». El nivel del siguiente pitido se ajusta a tu respuesta, como en una audiometría real. Son 12 frecuencias, unos 3 minutos.",
