...
const DICIONARIOS = {
  "pt-BR": {
    ...
    "perfil.fazerTeste": "Faça o teste de audição para criar o seu perfil",
    ...
    "aviso.macSemFone": "A conexão com o fone ainda não chegou à versão macOS.\nAqui você pode fazer o teste de audição e baixar o seu perfil.",
    "sis.pipewireAusente": "O PipeWire não está rodando neste sistema — a correção de som precisa dele.\nEle é o padrão nas distribuições atuais; verifique com: systemctl --user status pipewire",
  ...
  "en": {
    ...
    "perfil.fazerTeste": "Take the hearing test to create your profile",
    ...
    "aviso.macSemFone": "Connecting to the earbuds has not reached the macOS build yet.\nHere you can still run the hearing test and download your profile.",
    "sis.pipewireAusente": "PipeWire is not running on this system — the sound correction needs it.\nIt is the default on current distributions; check with: systemctl --user status pipewire",
    "rodape.codec": "codec: {c}", "rodape.firmware": "firmware {v}",
    "idioma": "Language",
  },
  ...
  "es": {
    ...
    "perfil.fazerTeste": "Haz el test de audición para crear tu perfil",
    ...
    "aviso.macSemFone": "La conexión con los auriculares aún no llegó a la versión de macOS.\nAquí puedes hacer la prueba de audición y descargar tu perfil.",
    "sis.pipewireAusente": "PipeWire no está en ejecución en este sistema — la corrección de sonido lo necesita.\nEs el estándar en las distribuciones actuales; verifica con: systemctl --user status pipewire",
