...
const DICIONARIOS = {
  "pt-BR": {
    ...
    "sis.aplicado": "Aplicado. O Equalizer APO relê a configuração na hora — o som já deve ter mudado. Vale mesmo com este app fechado; para desfazer, «Remover a correção do sistema».",
    "sis.removido": "Removido. O áudio do sistema voltou ao natural.",
    "sis.apoInstalarPergunta": "A correção de sistema usa o Equalizer APO (motor de áudio livre, GPL), que ainda não está instalado. Baixar e instalar agora? Você só precisa marcar o seu fone na lista e reiniciar uma vez.",
    "sis.apoInstalando": "O instalador do Equalizer APO vai abrir. Marque o dispositivo do seu fone na lista, conclua, reinicie o PC e clique em «Aplicar» de novo — daí em diante é instantâneo.",
  ...
  "en": {
    ...
    "sis.aplicado": "Applied. Equalizer APO reloads its config instantly — the sound should already have changed. It stays active with this app closed; to undo, use “Remove the system correction”.",
    "sis.removido": "Removed. System audio is back to natural.",
    "sis.apoInstalarPergunta": "System-wide correction uses Equalizer APO (a free, GPL audio engine), which is not installed yet. Download and install it now? You only need to tick your earbuds in the device list and reboot once.",
    "sis.apoInstalando": "The Equalizer APO installer will open. Tick your earbud device in the list, finish, reboot, and click “Apply” again — from then on it is instant.",
  ...
  "es": {
    ...
    "sis.aplicado": "Aplicado. Equalizer APO recarga su configuración al instante — el sonido ya debería haber cambiado. Sigue activo con esta app cerrada; para deshacer, «Quitar la corrección del sistema».",
    "sis.removido": "Quitado. El audio del sistema volvió a lo natural.",
    "sis.apoInstalarPergunta": "La corrección del sistema usa Equalizer APO (motor de audio libre, GPL), que aún no está instalado. ¿Descargarlo e instalarlo ahora? Solo tienes que marcar tu auricular en la lista y reiniciar una vez.",
    "sis.apoInstalando": "Se abrirá el instalador de Equalizer APO. Marca tu auricular en la lista, termina, reinicia y pulsa «Aplicar» otra vez — desde entonces es instantáneo.",
