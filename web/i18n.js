...
const DICIONARIOS = {
  "pt-BR": {
    ...
    "aviso.soWindows": "A conexão com o fone só existe na versão Windows por enquanto.\nAqui você pode fazer o teste de audição e baixar o seu perfil para usar num equalizador de sistema (EasyEffects, PipeWire).",
  ...
  "en": {
    ...
    "aviso.soWindows": "Connecting to the earbuds only exists in the Windows build so far.\nHere you can still run the hearing test and download your profile for a system equalizer (EasyEffects, PipeWire).",
    "rodape.codec": "codec: {c}", "rodape.firmware": "firmware {v}",
    "idioma": "Language",
  },
  ...
  "es": {
    ...
    "aviso.soWindows": "La conexión con los auriculares solo existe en la versión de Windows por ahora.\nAquí puedes hacer la prueba de audición y descargar tu perfil para un ecualizador de sistema (EasyEffects, PipeWire).",
